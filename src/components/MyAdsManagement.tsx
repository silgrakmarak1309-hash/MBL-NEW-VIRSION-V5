          ...
          onSubmitPayout={async (payoutData) => {
            if (onRequestPayout) {
              await onRequestPayout({
                ...
                upi_id: payoutData.upi_id || currentUser.upi_id || currentUser.payout_upi_id || '',
                bank_name: payoutData.bank_name || currentUser.bank_name || currentUser.payout_bank_name,
                account_no: payoutData.bank_account_no || currentUser.bank_account_no || currentUser.payout_account_no,
                ifsc_code: payoutData.bank_ifsc || currentUser.bank_ifsc || currentUser.payout_ifsc_code,
                user_role: 'seller',
              });
            }
          }}
